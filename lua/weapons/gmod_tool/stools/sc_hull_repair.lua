...
if ( CLIENT ) then
    language.Add( "Tool.sc_hull_repair.name", "Hull Repair Creation Tool" )
    language.Add( "Tool.sc_hull_repair.desc", "Spawns A Hull Repair." )
    language.Add( "Tool.sc_hull_repair.0", "Primary: Create/Update Hull Repair" )
